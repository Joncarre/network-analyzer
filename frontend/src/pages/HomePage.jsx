    ...
    <div className="min-h-screen bg-gray-900 py-12 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
            ...
            <h1 className="text-5xl font-bold bg-gradient-to-r from-gray-300 via-gray-100 to-gray-300 bg-clip-text text-transparent mb-4">
              Network Analyzer
            </h1>

          <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed mt-6">
        ...
        {/* Main Features Cards */}
              ...
              <div className="group bg-gray-800/70 backdrop-blur-sm p-8 rounded-3xl shadow-lg border border-gray-700/50 hover:shadow-xl transition-all duration-300">
              ...
              {/* Features List */}
        <div className="bg-gray-800/70 backdrop-blur-sm p-8 rounded-3xl shadow-lg border border-gray-700/50">
